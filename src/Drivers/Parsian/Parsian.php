...
class Parsian extends Driver
{
    ...
    public function purchase(): string
    {
        ...
        $soap = new SoapClient($this->getTokenGenerationUrl(), $soapOptions);
        $response = $soap->SalePaymentRequest($this->getTokenGenerationData());
    ...
    private function getTokenGenerationData(): array
    {
